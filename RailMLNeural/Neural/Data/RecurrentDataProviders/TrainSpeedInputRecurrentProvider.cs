...
{
    [Serializable]
    class TrainSpeedInputRecurrentProvider : BaseRecurrentDataProvider, IRecurrentDataProvider
    {
        public bool IsInput { get { return true; } }
        const string _name = "TrainSpeedInputRecurrentProvider";
        public String Name { get { return _name; } }
        public int Size { get { return 1; } }
        public int StartIndex { get; private set; }
        public List<string> Map { get { return new List<string>() { "Train Speed (km/h)" }; } }
        public NormalizationTypeEnum NormalizationType { get; set; }

        public TrainSpeedInputRecurrentProvider()
        {
