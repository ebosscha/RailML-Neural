...
{
    [Serializable]
    class SwitchCountInputRecurrentProvider : BaseRecurrentDataProvider, IRecurrentDataProvider
    {
        public bool IsInput { get { return true; } }
        const string _name = "SwitchCountInputRecurrentProvider";
        ...
        public SwitchCountInputRecurrentProvider()
        {
