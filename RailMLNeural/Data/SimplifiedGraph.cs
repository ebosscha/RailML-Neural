...
//        public SimplifiedGraphEdge[][] Edges
//        {
//            get
//            {
//                return _edges;
...
//        public List<TrainEdgeRepresentation> TrainEdgeList()
//        {
//            List<TrainEdgeRepresentation> result = new List<TrainEdgeRepresentation>();
//            for(int i = 0; i < _edges.Length; i++)
//            {
//                for(int j = i; i < _edges[i].Length; j++)
//                {
//                    if(_edges[i][j] != null)
//                    {
//                        result.AddRange(_edges[i][j].TraversingTrains);
//                    }
//                }
//            }
//            return result;
...
//            if(vertex1.PassingTrains.Any(x => x.TrainHeaderCode == HeaderCode))
//            {
//                int i = 0;
//            }
...
//                PredictedArrivalTime = ocpTT.times[0].arrival,
//                PredictedDepartureTime = ocpTT.times[0].departure
//            };
...
//                PredictedDepartureTime = ocpTT1.times[0].departure,
//                PredictedArrivalTime = ocpTT2.times[0].arrival
//            };
